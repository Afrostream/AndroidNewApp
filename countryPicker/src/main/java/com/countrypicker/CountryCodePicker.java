...
public class CountryCodePicker extends RelativeLayout {
    ...
    static int LIB_DEFAULT_COUNTRY_CODE = 33;
...
//        Log.d(TAG, "Initialization of CCP");
        ...
        holderView = mInflater.inflate(R.layout.layout_country_picker, this, true);
        textView_selectedCountry = (TextView) holderView.findViewById(R.id.textView_selectedCountry);

        //phone = (EditText) holderView.findViewById(R.id.phone);

       // setEditText_registeredCarrierNumber(phone);
...
//            Log.d(TAG, "No country for nameCode " + defaultCountryNameCode + " is found");
    ...
    public String getFullNumber() {
        ...
        if (editText_registeredCarrierNumber != null) {
            String phone= editText_registeredCarrierNumber.getText().toString();
            if (phone.startsWith("0"))
                phone=phone.substring(1);
            fullNumber = getSelectedCountry().getPhoneCode() + phone;
        } else {
