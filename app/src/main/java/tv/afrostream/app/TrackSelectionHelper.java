...
public final class TrackSelectionHelper implements View.OnClickListener,
    ...
    private View buildView(LayoutInflater inflater) {
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                if (trackView.isEnabled())root.addView(trackView);
        ...
        if (!haveSupportedTracks) {
            ...
            root.addView(inflater.inflate(R.layout.list_divider, root, false));
         //  if(enableRandomAdaptationView.isEnabled()) root.addView(enableRandomAdaptationView);
        }
    ...
    private static String buildTrackName(Format format) {
        ...
        if (MimeTypes.isVideo(format.sampleMimeType)) {
           ...
           /* trackName = joinWithSeparator(joinWithSeparator(joinWithSeparator(buildLanguageString(format),
            ...
            String languageStr="";
            if (buildLanguageString(format).equals("en"))
                languageStr="Anglais";
            else if(buildLanguageString(format).equals("fr"))
                languageStr="Français";

            trackName=languageStr;
            ...
            if (buildLanguageString(format).equals("eng"))
            languageStr="Anglais";
            else if (buildLanguageString(format).equals("fra"))
            languageStr="Français";
    ...
    private static String buildResolutionString(Format format) {
        ...
        else  if (format.width==640)
        {
            return  "Moyen";
        }
        else  if (format.width==854)
        {
            return  "Normal";
        }
